...
/*   Updated: 2023/10/13 18:25:38 by sbhatta          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "ClapTrap Constructor to initialize attributes is called!" << std::endl;
}
...
{
    std::cout << "ClapTrap Constructor with name initiaization is called!" << std::endl;
}
